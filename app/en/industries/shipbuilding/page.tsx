  ...
  return (
    <Section>
      <Container>
        ...
        <h1 className="mt-3 text-3xl font-semibold sm:text-4xl">Shipbuilding & Marine XR</h1>
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-white/70">Operational XR training and collaboration for complex procedures and multi-language workforce.</p>
